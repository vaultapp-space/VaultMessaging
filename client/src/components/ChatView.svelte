  ...
  async function handleFileChange(e) {
    ...
    try {
      ...
      for (let index = 0; index < totalChunks; index++) {
        ...
        const encryptedChunkBytes = await encryptChunk(key, arrayBuffer, index, baseIv);
      ...
      // 4. Send E2EE attachment metadata message
